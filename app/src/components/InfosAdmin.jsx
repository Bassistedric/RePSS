...
function FixedRolesTable({ fixes, t }) {
  ...
  return (
    <div className="border rounded-lg p-4" style={{ borderColor: colors.neutralBorder }}>
      <p className="text-sm font-semibold mb-3" style={{ color: colors.blue }}>
        {t("resp_approbation")} : {t("roles_fixes_suffixe")}
      </p>
      <div className="flex flex-col gap-1.5">
        {fixes.map((r) => (
          <div key={r.fonction} className="text-xs" style={{ color: colors.neutralTextStrong }}>
...
function ContactCard({ c }) {
  if (!c) return null;
  return (
    <div className="border rounded px-3 py-2 text-xs" style={{ borderColor: colors.neutralBorder }}>
...
export default function InfosAdmin({ dossier, setDossier, entreprise, hopitaux, t, onBack, onNext, tab, setTab }) {
  ...
  return (
    <div>
      ...
      <p className="text-sm mb-5" style={{ color: colors.blue }}>
      ...
      {tab === "renseignements" && (
        <div>
          ...
          <p className="text-sm font-semibold mt-5 mb-2" style={{ color: colors.blue }}>
      ...
      {tab === "administration" && (
        <div>
          ...
          <div className="border rounded-lg p-4 mt-4" style={{ borderColor: colors.neutralBorder }}>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3 text-xs" style={{ color: colors.neutralText }}>
              <span>
      ...
      {tab === "reglesSpecifiques" && (
        <div className="flex flex-col gap-4">
          <div className="border rounded-lg p-4" style={{ borderColor: colors.neutralBorder }}>
            ...
            <ul className="text-xs mb-3 pl-4 list-disc" style={{ color: colors.neutralTextStrong }}>
            ...
            <ul className="text-xs pl-4 list-disc" style={{ color: colors.neutralTextStrong }}>
          ...
          <div className="border rounded-lg p-4" style={{ borderColor: colors.neutralBorder }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
              <div>
                ...
                <p className="text-sm mb-1" style={{ color: colors.neutralTextStrong }}>
                  112
                </p>
                <input
                  type="text"
      ...
      <div className="flex justify-between mt-6">
        <button onClick={handleBack} className="px-5 py-2 rounded text-sm border" style={{ borderColor: colors.neutralBorderStrong }}>
          {t("bouton_retour")}
        </button>
        <button onClick={handleNext} className="px-5 py-2 rounded text-sm font-medium" style={{ background: colors.navy, color: "white" }}>
          {t("bouton_continuer")}
        </button>
      </div>
    </div>
